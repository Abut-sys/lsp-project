...
@section('content')
    <div class="space-y-8">
        ...
        <div class="text-center space-y-4">
            ...
            <h2 class="text-3xl font-bold text-gray-900">Login dengan Nomor Telepon</h2>
        </div>
        ...
        <!-- Login Form -->
        <form action="{{ route('user.login.phone.submit') }}" method="POST" class="space-y-6 max-w-md mx-auto">
            @csrf
            ...
            <div class="flex items-center space-x-2">
                <input type="checkbox" name="remember" id="remember"
                    class="w-5 h-5 border-2 border-gray-300 rounded-md focus:ring-blue-500 text-blue-600 transition-all">
        ...
        <div class="space-y-4 max-w-md mx-auto">
            ...
            <p class="text-center text-gray-500">
                Belum punya akun?
                <a href="{{ route('user.register.phone') }}" class="text-blue-500 hover:underline font-medium">Daftar
                    Sekarang</a>
            </p>
        </div>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelector('form').addEventListener('submit', function(e) {
                fullPhoneField.value = '+62' + phoneInput.value;
            });
        });
