...
@section('content')
    <div class="space-y-8">
        ...
        <div class="text-center space-y-4">
            ...
            <h2 class="text-3xl font-bold text-gray-900">Login dengan Email</h2>
        </div>
        ...
        <!-- Login Form -->
        <form action="{{ route('user.login.email.submit') }}" method="POST" class="space-y-6 max-w-md mx-auto">
            @csrf
        ...
        <div class="space-y-4 max-w-md mx-auto">
            <a href="{{ route('user.login.phone') }}"
                ...
                <span>Login dengan Nomor Telepon</span>
            </a>

            <p class="text-center text-gray-500">
                Belum punya akun?
                <a href="{{ route('user.register.email') }}" class="text-blue-500 hover:underline font-medium">Daftar
                    Sekarang</a>
            </p>
        </div>
    </div>
