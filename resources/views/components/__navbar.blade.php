    ...
    <div class="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div class="md:hidden">
            <button @click="mobileMenuOpen = !mobileMenuOpen"
                    class="text-gray-600 hover:text-blue-600 transition-all p-2 rounded-lg
                           hover:bg-white/30">
        ...
        <!-- Mobile Menu dengan transparansi -->
        <div class="md:hidden absolute top-full left-0 right-0 bg-white/90 backdrop-blur-md shadow-xl"
            ...
            <div class="px-4 py-4 space-y-4">
                <a href="{{ route('user.login.email') }}"
                   class="block pl-4 py-3 text-gray-700 hover:text-blue-600 rounded-lg
                          hover:bg-white/30 transition-all duration-300">
                    <i class="fas fa-sign-in-alt mr-3 text-blue-400/80"></i>
                    Login
                </a>
                <a href="{{ route('user.register.email') }}"
                   class="block w-full text-center bg-gradient-to-r from-blue-500/90 to-blue-600/90
